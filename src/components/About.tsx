      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="relative opacity-0 animate-fade-in animate-delay-100">
            ...
            <div className="absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-8 w-16 h-48 rounded-full bg-gradient-to-b from-peri-pink to-[#e60073] z-0"></div>
          </div>
