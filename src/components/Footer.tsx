      ...
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-peri-pink transition-colors">1:1 Coaching</a></li>
              <li><a href="#" className="text-gray-300 hover:text-peri-pink transition-colors">Group Workshops</a></li>
              <li><a href="#" className="text-gray-300 hover:text-peri-pink transition-colors">Hormone Balance Plan</a></li>
              <li><a href="#" className="text-gray-300 hover:text-peri-pink transition-colors">Menopause Mastery Course</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-3">
              <a href="#" className="text-gray-300 hover:text-peri-pink transition-colors">
